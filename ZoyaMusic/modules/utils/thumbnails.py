...
from ZoyaMusic.resource import thumbs, colors
from ZoyaMusic.utilities.config import YOUTUBE_IMG_URL
...
async def gen_thumb(videoid, user_id):
    ...
    try:
        ...
        bg = Image.open(f"ZoyaMusic/resource/{images}.png")
        ...
        font = ImageFont.truetype("ZoyaMusic/resource/font2.ttf", 45)
        ImageFont.truetype("ZoyaMusic/resource/font2.ttf", 70)
        arial = ImageFont.truetype("ZoyaMusic/resource/font2.ttf", 30)
        ImageFont.truetype("ZoyaMusic/resource/font.ttf", 30)
