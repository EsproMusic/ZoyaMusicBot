...
from ZoyaMusic.utilities.config import BANNED_USERS, MUSIC_BOT_NAME, adminlist, lyrical
...
from ZoyaMusic.modules.main.database import get_authuser_names, get_cmode
from ZoyaMusic.modules.main.decorators import (ActualAdminCB, AdminActual,
                                         language)
from ZoyaMusic.modules.utils.formatters import alpha_to_int
