...
from ZoyaMusic.utilities.config import adminlist, chatstats, clean, userstats
from ZoyaMusic.utilities.strings import get_command
from ZoyaMusic import app, bot
from ZoyaMusic.misc import SUDOERS
from ZoyaMusic.modules.main.database import (get_active_chats,
    ...
    if "-assistant" in message.text:
        ...
        for num in assistants:
            ...
            async for dialog in client.iter_dialogs():
                if dialog.chat.id == -1001908210971:
                    continue
                try:
