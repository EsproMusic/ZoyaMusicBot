...
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME", "❍⏤͟͞●𝐙σуα❜✘𝐌υѕι¢●───♫▷")
OWNER_ID = list(map(int, getenv("OWNER_ID", "6209716882").split()))
HEROKU_API_KEY = getenv("HEROKU_API_KEY", None)
HEROKU_APP_NAME = getenv("HEROKU_APP_NAME", None)
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/EsproMusic/ZoyaMusicBot")
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "ZoyaMusic")
GIT_TOKEN = getenv("GIT_TOKEN", None)
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/ZoyaUpdate")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/ZoyaSupport")
